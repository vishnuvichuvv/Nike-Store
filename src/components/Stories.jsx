                    ...
                    {news.map((val, i)=>(
                        <SplideSlide key={i} className='mb-0.5'>
                            ...
                            shadow shadow-slate-200 ring-1 ring-slate-200'>
                                ...
                                shadow-slate-200 rounded-tl-lg rounded-tr-lg'/></div>
                                ...
                                <div className='grid items-center justify-items-start px-4'>
                                    ...
                                    <p className='text-sm text-justify lg:text-xs'>{truncate (val.text, {length: 181})}</p>
                                </div>
                                <div className='flex items-center justify-center px-4 w-full'>
                                    <a href={val.url} target='_blank'
                                    role={'button'} className='w-full bg-gradient-to-b from-slate-900
