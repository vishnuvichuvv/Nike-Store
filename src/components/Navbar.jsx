        ...
        <nav className='flex items-center justify-between nike-container'>
            ...
            <ul className='flex items-center justify-center gap-2'>
                ...
                <li className='grid  items-center'>
                    ...
                    active:scale-110 transition-all duration-300 relative' onClick={onCartToggle}>
                        <ShoppingBagIcon className={`icon-style ${navState && "text-slate-900 transition-all duration-300"}`} />
                        <div className={`absolute top-4 right-0 shadow shadow-slate-100
                        w-4 h-4 text-[0.65rem] leading-tight font-medium rounded-full flex items-center justify-center
                        courser-pointer hover:scale-110 transition-all duration-300 ${navState ? 'bg-slate-900 text-slate-100 shadow-slate-900' 
