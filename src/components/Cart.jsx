...
import { selectCartItems, selectCartState, selectTotalAmount, selectTotalQTY, setClearCartItemQTY, setCloseCart, setGetTotals } from '../app/CartSlice'
    ...
    <div className={`fixed top-0 bottom-0 right-0 left-0 
        ...
        <div className={`blur-effect-theme h-screen max-w-xl w-full absolute right-0`}>
            ...
            <div>
              ...
              <div className='fixed bottom-0 bg-white w-full py-5 px-2 grid items-center'>
                <div className=' flex items-center justify-between'>
                  <h1 className='text-base font-semibold uppercase'>SubTotal</h1>
                  <h1 className='text-sm rounded bg-theme-cart text-slate-100 px-2 py-0.5'>${totalAmount}</h1>
                </div>
                <div className='grid items-center gap-2'>
                  <p className='text-sm font-medium text-center'>Taxes and shipping will calculated at shipping</p>
                  <button type='button' className='button-theme bg-theme-cart text-slate-100'>
                    Check Out
                  </button>
                </div>
              </div>
